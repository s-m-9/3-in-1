...
class BusRouteOneFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var screen = inflater.inflate(R.layout.fragment_bus_route_one, container, false)
        var noBusses = screen.findViewById<TextView>(R.id.noBusses)
        var averageText = screen.findViewById<TextView>(R.id.average1)
        ...
        var trip_view = screen.findViewById<RecyclerView>(R.id.BusRoute1CardListView)
